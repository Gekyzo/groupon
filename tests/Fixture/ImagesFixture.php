...
class ImagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'url' => ['type' => 'string', 'length' => 512, 'null' => false, 'default' => null, 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-04-02 09:47:50',
                'deleted' => '2019-04-02 09:47:50'
            ],
        ];
        parent::init();
    }
